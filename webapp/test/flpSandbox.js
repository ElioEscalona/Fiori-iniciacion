		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "invoices list",
									"targetURL": "#logalielioinvoices-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"logalielioinvoices-display": {
								"semanticObject": "logalielioinvoices",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=logalielio.invoices",
									"url": sap.ui.require.toUrl("logalielio/invoices")
								}
							}
						}
					}
